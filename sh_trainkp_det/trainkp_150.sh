...
#SBATCH --output /Midgard/home/zehang/project/keypoint_humanoids/stdout/stdout_kp_150_output.log
#SBATCH --error /Midgard/home/zehang/project/keypoint_humanoids/stdout/stdout_kp_150_error.log
...
cd $RUNPATH
python src/trainKp.py --data_path $LOCALDATAPATH/data --log_dir $LOGFOLDER --ck_path $CKFOLDER --batch_size 32 --epoch 100 --model pcn_det --augrot --augocc --augsca --savemodel --tasklist 8 18 10 20 --numkp 150
