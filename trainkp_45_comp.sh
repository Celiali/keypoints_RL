...
#SBATCH --output /Midgard/home/zehang/project/keypoint_humanoids/stdout/stdout_kp_45_detect_output.log
#SBATCH --error /Midgard/home/zehang/project/keypoint_humanoids/stdout/stdout_kp_45_detect_error.log
...
cd $RUNPATH
python src/trainKp_det.py --data_path $LOCALDATAPATH/data --log_dir $LOGFOLDER --ck_path $CKFOLDER --batch_size 32 --epoch 100 --model pcn_det_detect --augrot --augocc --augsca --savemodel --tasklist 2 4 6 12 14 16 --numkp 45
