...
#SBATCH --output /Midgard/home/zehang/project/keypoint_humanoids/stdout/stdout_kp_20_comp_output.log
#SBATCH --error /Midgard/home/zehang/project/keypoint_humanoids/stdout/stdout_kp_20_comp_error.log
...
cd $RUNPATH
python src/trainKp_det_comp.py --data_path $LOCALDATAPATH/data --log_dir $LOGFOLDER --ck_path $CKFOLDER --batch_size 32 --epoch 100 --model pcn_det_comp --augrot --augocc --augsca --savemodel --tasklist 2 4 6 12 14 16 --numkp 20
